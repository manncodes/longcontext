...
model=${MODEL:-Llama-3-8B-NExtLong-64K-Base} # replace this with your own model path
...
domains=(
    NExtLong-512K-dataset@33.33
    NExtLong-64K-dataset@66.67
)

domains_name=NExtLong512KMix
